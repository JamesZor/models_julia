# ==============================================================================
# r63 — Fractional-Kelly Betfair portfolio backtest and PostgreSQL persistence
# ==============================================================================
...
function r63_betfair_closing_odds(ds)
...
mkpath(output_dir)
CSV.write(joinpath(output_dir, "r63_portfolio_summary.csv"), summary)
CSV.write(joinpath(output_dir, "r63_trade_ledger.csv"), ledger)
...
println("="^155)
println("PostgreSQL now contains portfolio_runs, portfolio_bets, and portfolio_artifacts for all six candidates.")
