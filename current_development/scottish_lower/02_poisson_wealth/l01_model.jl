...
function tp02_model(; half_life_days=180.0, wealth_prior=truncated(Normal(0.10, 0.05), lower=0.0))
    DynamicPoissonWealthGoalsTimeDecayModel(interception_config=SLFP_PG.GlobalInterception(μ=Normal(0.2,0.1)),
        ...
        wealth_feature=SLFPLogSumWealthFeature(), w_wealth_prior=wealth_prior)
end
