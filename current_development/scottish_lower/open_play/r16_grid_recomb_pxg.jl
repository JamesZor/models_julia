...
println("\n", "="^95)
println("🚀 40-FOLD WALK-FORWARD PROXY xG (pxG) RECOMBINATION GRID (SCOTTISH LOWER)")
println("="^95)
...
# 3. Model Spec
tag = "recomb_pxg_wealth_integrated_hl365_hs2"
model_spec = TeamPxGRecombWealthIntegratedModel(
...
println("\n", "="^95)
println("✓ 40-FOLD PROXY xG RECOMBINATION + SQUAD WEALTH RUN COMPLETE!")
println("="^95)
