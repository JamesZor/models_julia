...
A clean-room rebuild of the Scottish Lower score-component model. Stages 1–6 now include the audited data/features contract, pure generic-number equations, Turing/AD smoke layer, and deterministic chain extraction/OOS component recombination validation. No sampling, experiment persistence, saved posterior chain, or leaderboard is implemented or reused.
