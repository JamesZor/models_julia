...
**Status:** Stages 1–5 are remotely validated; the Turing model and compiled gradient are ready for extraction/recombination work, but no MCMC has run. V1 is deliberately small: **only the NP-NOG component has team, league, month, and home effects.**
