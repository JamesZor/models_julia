...
**Status:** Stages 1–4 are remotely validated; no Turing model exists yet. V1 is deliberately small: **only the NP-NOG component has team, league, month, and home effects.**
