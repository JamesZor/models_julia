...
**Status:** Stages 1–4 are remotely validated. Stage 5 Turing/AD implementation is pending its remote profile run; no sampling exists. V1 is deliberately small: **only the NP-NOG component has team, league, month, and home effects.**
