# current_development/scottish_lower/open_play/r08_train_poisson_control.jl
#
# RUNNER: 40-Fold Walk-Forward Training Grid for Gross Goals Poisson Control Baseline
#
# Model:
# 1. goals_pois_ctl_hl365_hs2: Baseline Gross Goals Poisson Control (y_all_goals)
#
...
println("\n", "="^95)
println("🚀 40-FOLD WALK-FORWARD GROSS GOALS POISSON CONTROL BASELINE (SCOTTISH LOWER)")
println("="^95)
...
tag = "goals_pois_ctl_hl365_hs2"
model_spec = TeamGoalsPoissonModel(name = tag)
...
println("\n", "="^95)
println("✓ GROSS GOALS POISSON CONTROL RUN COMPLETE!")
println("="^95)
