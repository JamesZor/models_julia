# ==============================================================================
# MODEL 00 — PURE POISSON BASELINE : GATE 6 EVALUATION RUNNER
# ==============================================================================
#
# RUNNER. Evaluates OOS proper scores and calibration across all 360 fixtures.
#
# Usage:
#   include("current_development/scottish_lower/00_team_poisson/r02_evaluate.jl")
#
# ==============================================================================
...
println("=" ^ 74)
println("GATE 6 — EVALUATION (Model 00 Pure Poisson)")
println("=" ^ 74)
