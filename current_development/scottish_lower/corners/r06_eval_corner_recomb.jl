...
# ==============================================================================
# 4. MULTI-MARKET KELLY PORTFOLIO BENCHMARK (src/portfolio, Baker-McHale 800 Draws)
# ==============================================================================
banner("💰 4. MULTI-MARKET KELLY PORTFOLIO BENCHMARK (src/portfolio, BM 800 Draws)")
...
for exp in experiments
    ...
    if isfile(cache_file) && get(ENV, "REBUILD_BOOKS", "0") != "1"
        ...
        @info "Building MatchBooks for: $m_name across historical odds..."
