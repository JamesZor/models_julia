# current_development/MetaModels/l06_metrics.jl
#
# Standalone loader file implementing the Bernoulli-Gamma Hurdle model,
# Sharpe ratios (parametric and empirical), and growth rates (parametric and empirical)
# for evaluation of regime filter outputs.
#
# Can be included directly in the Julia REPL:
...
"""
    evaluate_multiple_markets(multi_ledger_dict::Dict{Symbol, DataFrame}, target_markets::Vector{Symbol}; min_edge=0.02)

Convenience function to loop through and print Hurdle metric reports for multiple markets from a stored dictionary.
Returns a Dict mapping each market Symbol to its NamedTuple of metrics.
"""
