# current_development/team_wealth/r06_evaluation_suite.jl
#
...
function find_newest_experiment(prefix::String)
    ...
    isempty(dirs) && error("r06: No experiment matching prefix '$prefix' found in $ENGINE_DIR")
...
out_path = joinpath(OUT_DIR, "evaluation_suite_results.jls")
