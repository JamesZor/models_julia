# current_development/team_wealth/l03_wealth_predict.jl
#
# ==============================================================================
# LOADER: Prediction Dispatch for Wealth-Enabled Engine
# ==============================================================================
#
# PURPOSE:
#   Implements `Predictions` method overloads for
#   `DynamicSmileDoublePoissonXGWealthPlayerTimeDecayModel`.
#
# ==============================================================================
...
Pred.extract_params(::DynamicSmileDoublePoissonXGWealthPlayerTimeDecayModel, row) =
    (λ_h = row.λ_h, λ_a = row.λ_a, λ_tot = row.λ_tot, φ = row.φ)

# Grid kernel: independent Double Poisson
function _smile_poisson_grid_wealth(λ_h, λ_a; max_goals::Int=12)
    n = length(λ_h)
...
function Pred.compute_score_matrix(
    ::DynamicSmileDoublePoissonXGWealthPlayerTimeDecayModel, params; max_goals::Int=12
)
    grid = _smile_poisson_grid_wealth(params.λ_h, params.λ_a; max_goals)
