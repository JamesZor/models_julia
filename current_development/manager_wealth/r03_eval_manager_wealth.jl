# current_development/manager_wealth/r03_eval_manager_wealth.jl
#
...
function find_newest_experiment(pattern::Regex)
    ...
    isempty(dirs) && error("r03: No experiment matching pattern '$pattern' found in $ENGINE_DIR")
...
experiments = [exp_noanchor, exp_wealth, exp_anchored, exp_wealth_anchor, exp_mgr_wealth]
...
out_path = joinpath(OUT_DIR, "evaluation_suite_manager_wealth_results.jls")
