# current_development/manager_wealth/r02_train_manager_wealth.jl
#
# RUNNER: Train the Hierarchical Manager + Unanchored Team Wealth Model on Ireland 79
#
# ==============================================================================
# EXPERIMENT SETUP
# ==============================================================================
...
# - Manager Tactical Pace: HierarchicalManagerPace (σ_pace ~ Truncated(Normal(0, 0.15), 0, Inf))
# - Manager Quality: HierarchicalManagerQuality (σ_mgr ~ Truncated(Normal(0, 0.15), 0, Inf))
# - Team Wealth Prior: Truncated(Normal(0.105, 0.05), lower = 0.0)
# - Data: ds_ire79.jls (pinned DataStore)
# - Target Seasons: ["2024", "2025", "2026"] (history_seasons = 2, match_biweek)
...
include(joinpath(@__DIR__, "l01_manager_wealth_data.jl"))
include(joinpath(@__DIR__, "l02_manager_wealth_engine.jl"))
include(joinpath(@__DIR__, "l03_manager_wealth_predict.jl"))
...
function make_manager_wealth_engine()
    return DynamicSmileDoublePoissonXGWealthManagerPlayerTimeDecayModel(
...
println("\n", "="^90)
println("STARTING FULL TRAINING: l2_ire79_mgr_wealth (Unanchored Manager + Team Wealth)")
println("="^90)

task = Experiments.create_experiment_task(
    ds, make_manager_wealth_engine(), "l2_ire79_mgr_wealth", OUT_DIR;
...
println("\n", "="^90)
println("🎉 l2_ire79_mgr_wealth TRAINING & PERSISTENCE FINISHED")
println("="^90)
