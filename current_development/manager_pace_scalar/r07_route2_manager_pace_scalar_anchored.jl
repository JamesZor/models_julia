# current_development/manager_pace_scalar/r07_route2_manager_pace_scalar_anchored.jl
#
# RUNNER: 6-Way Route 2 Out-Of-Sample Benchmark Evaluation (Including Anchored Scalar Manager Pace)
#
# Comparing:
...
function find_newest_experiment(pattern::Regex)
    ...
    isempty(dirs) && error("r07: No experiment matching pattern '$pattern' found in $ENGINE_DIR")
...
banner("GENERATING OUT-OF-SAMPLE BOOKS & SELECTIONS (MULTI-THREADED)")
...
arm2 = process_arm(ds, exp_anchored,          "2. Market Anchored (sup40)")
arm3 = process_arm(ds, exp_wealth,            "3. Team Wealth Unanchored")
arm4 = process_arm(ds, exp_wealth_anchor,     "4. Team Wealth + Anchored")
arm5 = process_arm(ds, exp_mgr_pace_scalar,   "5. Scalar Pace + Wealth Unanchored")
arm6 = process_arm(ds, exp_mgr_pace_anchored, "6. Scalar Pace + Wealth + Anchored")
...
out_file = joinpath(OUT_DIR, "route2_anchored_pace_scalar_vs_baselines.jls")
