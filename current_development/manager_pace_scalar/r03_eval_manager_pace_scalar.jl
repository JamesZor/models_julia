# current_development/manager_pace_scalar/r03_eval_manager_pace_scalar.jl
#
...
# 6. Scalar Manager Pace + Wealth Unanchored (`l2_ire79_mgr_pace_scalar`)
...
out_path = joinpath(OUT_DIR, "evaluation_suite_manager_pace_scalar_results.jls")
